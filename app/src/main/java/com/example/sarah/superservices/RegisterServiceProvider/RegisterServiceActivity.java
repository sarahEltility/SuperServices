...
public class RegisterServiceActivity extends AppCompatActivity implements RegisterServiceViewOps,View.OnClickListener {

//find views
private ProgressBar progressBar;
private Button Submit;
private EditText name,email,phone,password,age,service;
    private TextView hint;
    Context mcontext;


//object to connect with presenter
private RegisterServicePresenterProvidedOps presenter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        age=(EditText)findViewById(R.id.age_edit_text_yourpass);
        service=(EditText)findViewById(R.id.service_edit_text_yourpass);
        ...
        presenter =  new RegisterServicePresenterImpl(this);
    ...
    public void onClick(View view) {
        ...
        else if(!isPasswordValid(password.getText().toString()))
        {
            ...
            presenter.validateCredentials(name.getText().toString(), email.getText().toString(),phone.getText().toString(),password.getText().toString(),age.getText().toString(),service.getText().toString());
        }
    }
