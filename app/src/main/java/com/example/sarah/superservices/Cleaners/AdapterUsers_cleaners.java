...
public class AdapterUsers_cleaners extends RecyclerView.Adapter<AdapterUsers_cleaners.ViewHolder> implements View.OnClickListener{

    ArrayList<Users> arrayList;
    Context context;
    CleanerActivity followerActivity;
    Users encap = new Users();

    public AdapterUsers_cleaners(ArrayList<Users> arrayList, Context context, CleanerActivity followerActivity) {
        this.arrayList = arrayList;
        this.context = context;
        this.followerActivity = followerActivity;
    }
    @Override
    public AdapterUsers_cleaners.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(AdapterUsers_cleaners.ViewHolder holder, int position) {
