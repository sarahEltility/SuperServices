...
public class LaundaryActivity extends AppCompatActivity implements LaundariesViewOps,View.OnClickListener {
...
Connector c;
    ...
    private AdapterUsers_laundary adapter;

        //object to connect with presenter
    private LaundaryPresenterProviderOps presenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        presenter =  new LaundaryPresenterImpl(this);
    ...
    @Override
    public void  setRecyclerAdapter(AdapterUsers_laundary adapter) {
