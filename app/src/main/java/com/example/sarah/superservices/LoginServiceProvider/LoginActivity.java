...
import com.example.sarah.superservices.RegisterServiceProvider.RegisterServiceActivity;
...
public class LoginActivity extends AppCompatActivity implements LoginServiceViewOps, View.OnClickListener {
    ...
    private LoginServicePresenterProviderOps presenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        presenter = new LoginServicePresenterImpl(this);
        regist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i =new Intent(getApplicationContext(),RegisterServiceActivity.class);
                startActivity(i);
            }
        });
    }
